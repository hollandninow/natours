...
class Axios {
  ...
  request(configOrUrl, config) {
    ...
    config.headers = new _AxiosHeaders.default(config.headers, defaultHeaders); // filter out skipped interceptors
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaG9sbGFuZG4iLCJhIjoiY2xhNnp1anYxMDFsaDNwbzJrc3JubTFuYiJ9.M5YUbgOLbt5tMOQWmhemBw';
...
var stripe = Stripe('pk_test_51M6KnfArdCDhrA6362g7THqTRuvGbcwawaZDJJjvjx1fYYLuDwzXawZprtYP6Uj6bMTmlBiJtGSaDe3H9x6KOhBE00b7oaa4hd');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"editReview.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(rating, review, reviewId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"submitReview.js":[function(require,module,exports) {
"use strict";
...
var _editReview = require("./editReview");

var _submitReview = require("./submitReview");
...
var bookBtn = document.getElementById('book-tour'); // Elements for edit review form

var editReviewBtnArray = document.querySelectorAll('.btn--edit');
var closeModalBtnArray = document.querySelectorAll('.close-modal');
var reviewFormModalArray = document.querySelectorAll('.review-form__modal');
var editReviewFormArray = document.querySelectorAll('.form--edit-review'); // Elements for create review form

var createReviewBtn = document.getElementById('leave-review');
var closeModalBtn = document.querySelector('.close-modal');
var reviewFormModal = document.querySelector('.review-form__modal');
var createReviewForm = document.querySelector('.form--create-review'); // DELEGATION
...
if (alertMessage) (0, _alerts.showAlert)('success', alertMessage, 15); // For My Reviews page

if (editReviewBtnArray) {
  editReviewBtnArray.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      var editReviewModal = document.getElementById("".concat(btn.id, "-modal"));
...
if (closeModalBtnArray) {
  closeModalBtnArray.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
...
if (reviewFormModalArray) {
  reviewFormModalArray.forEach(function (el) {
...
if (editReviewFormArray) {
  editReviewFormArray.forEach(function (el) {
    return el.addEventListener('submit',
    /*#__PURE__*/
    function () {
      var _ref2 = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee2(e) {
        var id, rating, review;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                e.preventDefault();
                id = el.parentElement.id.split('-')[0];
                rating = document.getElementById("".concat(id, "-rating")).value;
                review = document.getElementById("".concat(id, "-review")).value;
                _context2.next = 6;
                return (0, _editReview.editReview)(rating, review, id);
...
if (createReviewBtn) {
  createReviewBtn.addEventListener('click', function (e) {
...
if (createReviewForm) {
  createReviewForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(
    /*#__PURE__*/
    _regeneratorRuntime().mark(function _callee3(e) {
      var rating, review, tourId;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 6;
              return (0, _submitReview.submitReview)(rating, review, tourId);
