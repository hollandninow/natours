      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session.data.session.id); // 2) Create checkout form + charge credit card
